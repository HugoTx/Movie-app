...
//Fetch data from the TMBD API
async function fetchAPIData(endpoint) {
  const API_KEY = 'fbaddf0cf27e3f626b618c2ec42bb7f4';
...
function highlightActiveLink() {
  ...
  links.forEach((link) => {
    if (link.getAttribute('href') === global.currenPage) {
